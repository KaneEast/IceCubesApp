...
@Observable public class UserPreferences {
  class Storage {
    ...
    @AppStorage("app_default_post_visibility") public var appDefaultPostVisibility: Visibility = .pub
    @AppStorage("app_default_reply_visibility") public var appDefaultReplyVisibility: Visibility = .pub
  ...
  public var appDefaultPostVisibility: Visibility {
    didSet {
      storage.appDefaultPostVisibility = appDefaultPostVisibility
    }
  }

  public var appDefaultReplyVisibility: Visibility {
    didSet {
  ...
  public var postVisibility: Visibility {
  ...
  private func getReplyVisibility() -> Visibility {
    getMinVisibility(postVisibility, appDefaultReplyVisibility)
  }

  public func getReplyVisibility(of status: ModelsStatus) -> Visibility {
  ...
  public static func getIntOfVisibility(_ vis: Visibility) -> Int {
    switch vis {
    case .direct:
      0
    case .priv:
