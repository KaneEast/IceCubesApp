...
public final class ModelsStatus: AnyStatus, Codable, Identifiable, Equatable, Hashable {
  public static func == (lhs: ModelsStatus, rhs: ModelsStatus) -> Bool {
  ...
  public static func placeholder(forSettings: Bool = false, language: String? = nil) -> ModelsStatus {
  ...
  public static func placeholders() -> [ModelsStatus] {
    [.placeholder(), .placeholder(), .placeholder(), .placeholder(), .placeholder()]
  }

  public var reblogAsAsStatus: ModelsStatus? {
    if let reblog {
...
extension ModelsStatus: Sendable {}
