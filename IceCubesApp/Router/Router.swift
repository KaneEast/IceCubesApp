...
public enum SheetDestination: Identifiable {
  ...
  case editStatusEditor(status: ModelsStatus)
  case replyToStatusEditor(status: ModelsStatus)
  case quoteStatusEditor(status: ModelsStatus)
  case mentionStatusEditor(account: Account, visibility: Visibility)
  case listEdit(list: ModelsList)
